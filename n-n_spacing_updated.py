    ...
    with open(filename, "r") as f:
      ...
      for iteration in iteration_tags:
        ...
        for atom in atom_tags:
          ...
          position_data_list_ang = [(float(val))/1.89 for val in position_data.split()]
        ...
        n_difference_modified = [(n_difference[0] % lx), (n_difference[1] % ly), (n_difference[2] % lz)]
        n_distance_true = [math.sqrt(sum(val**2 for val in n_difference_modified))]
...
spacing("ssages_out_0_run_0_cleaned_frame1.xml")
