...
def parser(input, atom1, atom2, d0, r0, n, m, threshold=0.999):
    with open(input, "r") as r:
        ...
        coord_count = 0  # Initialize coordination number count
                ...
                if "Direct configuration" in line:
                    ...
                    for j in range(min(len(specific_positions1), len(specific_positions2))):
                        for k in range(j, min(len(specific_positions1), len(specific_positions2))):
                            ...
                            s_ij = switching_function(euclidean_dist, d0, r0, n, m)
                            if s_ij > threshold:
                                coord_count += 1  # Increment coordination number
        ...
        plt.show()
        print(f"Coordination number: {coord_count}")
